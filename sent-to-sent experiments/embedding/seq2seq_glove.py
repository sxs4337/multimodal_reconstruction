...
def embedding_attention_seq2seq(encoder_inputs,
	...
	with variable_scope.variable_scope("embedding_attention_seq2seq", dtype=dtype) as scope:
		...
		# noise = tuple(tf.split(tf.random_normal([1,900],0,0.3),3,axis=1, name='noise_split'))
		# noisy_enc_state = tuple([sum(x) for x in zip(noise,encoder_state)])
		# encoder_state = (enc1, enc2, enc3)
		# Decoder.
		output_size = None
